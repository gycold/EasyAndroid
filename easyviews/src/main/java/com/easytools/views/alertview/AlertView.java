...
/**
 * package: com.easytools.views.alertview.AlertView
 * author: gyc
 * description:底部弹窗Dialog
 * time: create at 2017/3/6 22:41
 */
...
public class AlertView {
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive, String[]
            others, Context context, Style style, OnItemClickListener onItemClickListener) {
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_alert,
                contentContainer);
        initHeaderView(viewGroup);
