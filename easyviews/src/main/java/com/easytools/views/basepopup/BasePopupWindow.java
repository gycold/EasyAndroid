...
import com.easytools.views.util.InputMethodUtils;
import com.easytools.views.util.SimpleAnimUtil;

import java.lang.reflect.Field;

/**
 * package: com.easytools.views.basepopup.BasePopupWindow
 * author: gyc
 * description:抽象通用popupwindow的父类，使用方法：
 * Step 1:
 * 像您平时定制activity布局文件一样定制您的popup布局
 *（请注意，展示动画的那个view必须是popupview的子view）
 *
 * Step 2:
 * 新建一个类继承Basepopup
 * Step 3:
 ...
 *
 * Step 4:
 * 把刚才实现的popup给new出来并调用show方法
 * https://github.com/razerdp/BasePopup
 * time: create at 2017/5/15 23:35
 */
