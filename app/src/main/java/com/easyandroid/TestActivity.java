...
public class TestActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv1.setText(RandomUtils.getRandom(2) + "");
        tv2.setText(RandomUtils.getRandom(2) + "");
        ...
        spUtils.putString("test1", "abc");
        spUtils.putInt("test2", 12);
        spUtils.putBoolean("test3", true);
        Log.d("-----------", convertCount(128));
        Log.d("-----------", convertCount(1566));
        Log.d("-----------", convertCount(25685));
        Log.d("-----------", convertCount(956255));
        Log.d("-----------", convertCount(6342358));
        Log.d("-----------", convertCount(34958658));

        int a = 28;
        float b = 25.00f;
        float c = b / a;
        Log.d("------b-----", String.valueOf(c));
        Log.d("------c-----", RoundUtils.round(c, 2));

    }

    public static String convertCount(int count) {
        if (count < 1000) {//展示为具体数字
            return String.valueOf(count);
        } else if (count < 100000) {//展示为1k到99k
            return count / 1000 + "k";
        } else if (count < 1000000) {//展示为10w到99w
