package com.easytools.tools.log;
...
/**
 * package: com.easytools.tools.log.EasyLog
 * author: gyc
 * description: 重构log日志类，使得可以打印长日志
 * time: create at 2022/7/5 2:19
 */
public class EasyLog {
    ...
    private static StackTraceElement getCurrentStackTrace() {
        ...
        int stackOffset = getStackOffset(trace, EasyLog.class);
        if (stackOffset == -1) {
