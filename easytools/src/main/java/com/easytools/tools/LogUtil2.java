...
/**
 * package: com.easytools.tools.LogUtil2
 * author: gyc
 * description:打印日期工具类，采购建造者模式构建，支持写入本地文件
 * time: create at 2017/1/19 17:48
 */
...
public class LogUtil2 {
    ...
    public static void init(Context context, boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        ...
        LogUtil2.logSwitch = logSwitch;
        LogUtil2.log2FileSwitch = log2FileSwitch;
        LogUtil2.logFilter = logFilter;
        LogUtil2.tag = tag;
    }
