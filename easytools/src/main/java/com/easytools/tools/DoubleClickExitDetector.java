...
/**
 * package: com.easytools.tools.DoubleClickExitDetector
 * author: gyc
 * description:双击退出应用识别器
 * time: create at 2017/1/18 17:59
 */

public class DoubleClickExitDetector {

    public static String DEFAULT_HINT_MESSAGE_CHINA = "再按一次退出程序";
    public static String DEFAULT_HINT_MESSAGE_OTHER = "Press again to exit the app";
    ...
    public DoubleClickExitDetector(Context context) {
        this(context, (Locale.CHINA.equals(getSystemLocale(context)) || "zh_CN_#Hans".equals(getSystemLocale(context).toString())) ? DEFAULT_HINT_MESSAGE_CHINA : DEFAULT_HINT_MESSAGE_OTHER, 2000);
    }
