...
/**
 * package: com.easytools.tools.LanguageUtils
 * author: gyc
 * description:
 * time: create at 2024/6/19 13:47
 */
public class LanguageUtils {
    ...
    private static void applyLanguageReal(final Locale locale,
                                          final boolean isRelaunchApp) {
        if (locale == null) {
            UtilsBridge.getSpUtils4Utils().putString(KEY_LOCALE, VALUE_FOLLOW_SYSTEM, true);
        } else {
            UtilsBridge.getSpUtils4Utils().putString(KEY_LOCALE, locale2String(locale), true);
        }
