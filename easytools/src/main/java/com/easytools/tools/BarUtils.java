...
/**
 * package: com.easytools.tools.BarUtils
 * author: gyc
 * description:状态栏相关的工具类
 * time: create at 2017/1/1 3:48
 */
...
public class BarUtils {
    ...
    public static boolean isStatusBarExists(Activity activity) {
        ...
        return (params.flags & WindowManager.LayoutParams.FLAG_FULLSCREEN) != WindowManager
                .LayoutParams.FLAG_FULLSCREEN;
    }
    ...
    public static void showNotificationBar(Context context, boolean isSettingPanel) {
        String methodName = (Build.VERSION.SDK_INT <= 16) ? "expand" : (isSettingPanel ?
                "expandSettingsPanel" : "expandNotificationsPanel");
